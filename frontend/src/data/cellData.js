...
export const cellData = [
  ...
  { path: '/israel_2', en_name: 'israel_2', cells: mapCellName['israel_2'], name: '이스라엘군2', to: '/israel_2', activeStyle: true, clsName: 'index'},
  ...
  { path: '/turkey', en_name: 'turkey', cells: mapCellName['turkey'], name: '터키군', to: '/turkey', activeStyle: true, clsName: 'index'},
  { path: '/russia', en_name: 'russia', cells: mapCellName['russia'], name: '연해주', to: '/russia', activeStyle: true, clsName: 'index'},
